...
class Producto{
	...
	function registrar_producto(){
		...
		$sql = "INSERT INTO Producto ('id_Producto','nomb_Producto','marc_Producto','descrip_Producto','id_Categoria','id_Usuario') VALUES (null,'$this->nombre','$this->marca','$this->descripcion','$this->img_producto','$this->categoria','$this->usuario')";
